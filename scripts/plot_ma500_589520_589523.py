#!/usr/bin/env python
"""500-pt MA of moe_cumulative_reward for 589520 and 589523 (individual + overlay)."""
import glob
import os
import re
...
RUNS = [
    ("589520", "pyrenees_6p_ind_directional_k3_sw1_589520",
     "589520  Pyrenees 6p ind  dir k3 sw1", "#1f77b4"),
    ("589523", "palisades_5p_ind_directional_k3_sw2_589523",
     "589523  Palisades 5p ind  dir k3 sw2", "#d62728"),
]
...
ax.set_xlabel("Episode")
ax.set_ylabel(f"{COL}  ({WIN}-pt moving avg)")
ax.set_title("589520 (Pyrenees sw1) vs 589523 (Palisades sw2) — 500-pt MA of moe_cumulative_reward\n"
             "different scenarios/difficulty, not a direct apples-to-apples comparison")
ax.legend(fontsize=9, loc="lower right")
ax.grid(alpha=0.3)
fig.tight_layout()
save = "verification_plots/moe_ma500_compare_589520_589523.png"
fig.savefig(save, dpi=130)
print(f"saved -> {save}")
