...
from examples.uam.intraCity.transporter_model.agents import TransportAgent
from sosid.model.routing import evaluate_neighbours, find_best_route

DIJKSTRA_TEST_CASES = {"argnames": "origin_destination, expected_result ", "argvalues": [([0,2], [1,2]), ([0,3], [1,2,3]), ([0,8], [1,2,8])]}
NEIGHBOURS = {0: [1, 7], 1: [0, 2, 7], 2: [1, 3, 5, 8], 3: [2, 4, 5], 4:[3, 5], 5: [2,3,4,6], 6:[5, 7, 8], 7:[0, 1, 6,8], 8:[2,6,7]}
ALL_NODES = [0,1,2,3,4,5,6,7,8]
VALUES = {"0_1": 4, "0_7": 8, "1_7": 11, "1_2": 8, "2_8":2, "2_3": 7, "2_5":4, "3_4": 9, "3_5": 14, "4_5": 10, "5_6": 2, "6_8": 6, "6_7": 1, "7_8": 7}
...
def test_find_best_route(origin_destination, expected_result):
    ...
    answer = find_best_route(origin, destination, value_func, ALL_NODES, NEIGHBOURS)
...
NEIGHBOURS_2 = {0: [1, 7], 1: [0, 2, 7], 2: [1, 3, 8], 3: [2, 4, 5], 4:[3, 5], 5: [3,4,6], 6:[5,8], 7:[0, 1], 8:[2,6]}
...
def test_evaluate_neighbours(criteria, expected_neighbours):
    neighbours = evaluate_neighbours(ALL_NODES, neighbouring_values_func, criteria)
